...
| **Cumple (Sí/No)** | Sí |
| **Descripción de la Prueba** | Verificar que el usuario pueda seleccionar punto de destino interactuando con el mapa, y que el sistema valide que se encuentren dentro del área de cobertura (Quito). |
