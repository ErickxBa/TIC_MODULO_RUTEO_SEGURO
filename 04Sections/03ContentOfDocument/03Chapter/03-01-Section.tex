...
\section{Resultados Pruebas Funcionales}
Los resultados de las pruebas funcionales se consolidan en el Anexo \ref{anexo:resultados-pruebas-funcionales}, donde se evidencia que el Módulo de Ruteo Seguro cumple con los requerimientos establecidos en las Historias de Usuario. En particular, la prueba CP-04 confirmó que el algoritmo de ruteo implementado en Nest.js asigna correctamente los pesos de riesgo a los nodos y aristas, priorizando rutas seguras incluso si implican un mayor tiempo de viaje. Este resultado valida la eficacia del enfoque de penalización basado en datos geoespaciales y demuestra que el sistema puede adaptarse dinámicamente a cambios en el entorno urbano para proteger a los usuarios finales, este resultado se muestra en la Figura \ref{fig:prueba04_resultado} y la misma ruta ya con los pesos de riesgo aplicados en la Figura \ref{fig:prueba04_resultado_ruta}.

\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{../02Figures/03Chapter/Prueba04.png}
\caption{Resultado de la Prueba CP-04}
\label{fig:prueba04_resultado}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{../02Figures/03Chapter/Prueba04_ruta.png}
\caption{Ruta sin riesgo y Ruta con riesgo penalizado}
\label{fig:prueba04_resultado_ruta}
\end{figure}
