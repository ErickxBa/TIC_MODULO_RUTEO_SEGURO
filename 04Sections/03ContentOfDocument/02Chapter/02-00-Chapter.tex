...
\hline
\multirow{2}{3.5cm}{\textbf{HU-01:} Selección de Origen y Destino}
 & \textbf{Prioridad} & Alta \\ \cline{2-3}
 & \textbf{Estimación} & 5 Puntos \\
\hline
...
\begin{tabularx}{\textwidth}{|p{3.5cm}|p{3cm}|X|}
\hline
\multirow{2}{3.5cm}{\textbf{HU-02:} Cálculo de Ruta Segura}
 & \textbf{Prioridad} & Alta \\ \cline{2-3}
 & \textbf{Estimación} & 8 Puntos \\
\hline
\multicolumn{2}{|l|}{\textbf{Descripción}} &
...
\begin{tabularx}{\textwidth}{|p{3.5cm}|p{3cm}|X|}
\hline
\multirow{2}{3.5cm}{\textbf{HU-03:} Visualización de Trayecto en Mapa}
 & \textbf{Prioridad} & Alta \\ \cline{2-3}
 & \textbf{Estimación} & 5 Puntos \\
\hline
\multicolumn{2}{|l|}{\textbf{Descripción}} &
...
\begin{tabularx}{\textwidth}{|p{3.5cm}|p{3cm}|X|}
\hline
\multirow{2}{3.5cm}{\textbf{HU-04:} Actualización de Pesos por Incidentes}
 & \textbf{Prioridad} & Media \\ \cline{2-3}
 & \textbf{Estimación} & 8 Puntos \\
\hline
\multicolumn{2}{|l|}{\textbf{Descripción}} &
...
\begin{tabularx}{\textwidth}{|p{3.5cm}|p{3cm}|X|}
\hline
\multirow{2}{3.5cm}{\textbf{HU-05:} Recálculo de Ruta por Desvío}
 & \textbf{Prioridad} & Media \\ \cline{2-3}
 & \textbf{Estimación} & 8 Puntos \\
\hline
\multicolumn{2}{|l|}{\textbf{Descripción}} &
...
\begin{tabularx}{\textwidth}{|p{3.5cm}|p{3cm}|X|}
\hline
\multirow{2}{3.5cm}{\textbf{HU-06:} Carga y Estructuración de Red Vial}
 & \textbf{Prioridad} & Alta \\ \cline{2-3}
 & \textbf{Estimación} & 5 Puntos \\
\hline
\multicolumn{2}{|l|}{\textbf{Descripción}} &
...
El desarrollo del módulo inició a partir del aprovisionamiento de la base de datos en la nube.  Se estableció un servidor en Azure SQL Database (\texttt{server-ruteo-seguro.database.windows.net}), se eligió este motor por su manera de procesar datos geoespaciales usando el tipo de dato \texttt{GEOGRAPHY}. Esta propiedad es esencial para el ruteo, porque posibilita la ejecución de cálculos relacionados con distancias y la búsqueda de intersecciones en función de coordenadas geográficas reales. El plan de servicio seleccionado dentro de la nube de Azure se muestra en la Figura \ref{Configuración_Azure.png}
...
Con la creación del recurso de base de datos, se procedió a la definición de las tablas \texttt{Nodos}, \texttt{Aristas} e \texttt{Incidentes} con sus respectivos campos y tipos de datos. Se establecieron relaciones entre las tablas para representar la topología de la red vial y se configuraron índices espaciales en los campos geográficos para optimizar las consultas de búsqueda de rutas, el script SQL para la creación de las tablas en la base de datos (\texttt{db-ruteo-seguro}) se muestra en la Figura \ref{Creación_BDD.png}.

\begin{figure}[htbp]
    \centering  
    \includegraphics[width=0.9\textwidth]{../02Figures/02Chapter/Creación_BDD.png}
    \caption{Script para la creación de las tablas base de datos}
    \label{Creación_BDD.png}    
\end{figure}



Luego, se procedió a la adquisición de la cartografía sin procesar de Quito, obtenida desde OpenStreetMap, la cual se limpió y transformó para que se ajustara al modelo de datos definido en la base de datos. Finalmente, se desarrollaron scripts de ETL (Extract, Transform, Load) para migrar los datos geográficos a las tablas Nodos y Aristas, asegurando que cada segmento de calle (arista) estuviera correctamente vinculado a sus respectivos cruces (nodos) y que se crearan índices espaciales para optimizar las consultas de búsqueda.
