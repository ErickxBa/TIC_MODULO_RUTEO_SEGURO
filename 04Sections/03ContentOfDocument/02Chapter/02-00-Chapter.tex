...
Con la creación del recurso de base de datos, se procedió a la definición de las tablas \texttt{Nodos}, \texttt{Aristas} e \texttt{Incidentes} con sus respectivos campos y tipos de datos. Se establecieron relaciones entre las tablas para representar la topología de la red vial y se configuraron índices espaciales en los campos geográficos para optimizar las consultas de búsqueda de rutas, el script SQL para la creación de las tablas en la base de datos (\url{db-ruteo-seguro}) se muestra en la Figura \ref{Creación_BDD.png}.
